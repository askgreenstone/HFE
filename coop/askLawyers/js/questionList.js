...
function showid(idname,uid){
  ...
  var layerExist = document.getElementById('layer');
  if(!layerExist){
  ...
  if(uid){
    document.getElementById("openId").value=uid;
    document.getElementById("openIdold").value=uid;
  }
