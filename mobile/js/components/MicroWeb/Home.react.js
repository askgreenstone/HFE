  ...
  render: function() {
    return (
      <div className='temp'>
        ...
        <div><Link to='/index024'><img src='image/index024.png'/><span>index024</span></Link></div>
        <div><Link to='/index025'><img src='image/index025.png'/><span>index025</span></Link></div>
      </div>
      );
  },
});
