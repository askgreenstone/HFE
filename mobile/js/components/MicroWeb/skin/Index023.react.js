...
var Index023 = React.createClass({
  ...
  getLatestNews:function(){
    ...
    $.ajax({
      ...
      error:function(){
        athis.showRefresh('系统开了小差，请刷新页面');
      }.bind(this)
    })
    ...
    var navNodes = this.state.navArrs.map(function(item,i){
      return(
		...
		return (
            ...
            <div className="theme023_content_lawyer">{this.state.nm}<i> {this.state.rk}</i></div>
          ...
          imgUrl={global.img+this.state.shareImg} target="index023"/>
          <Message/>
