...
var Dynamic = React.createClass({
  ...
  render: function() {
    ...
    // isFromWhichApp    在线法律传1，德和衡传2，时间涟漪传3，菁英时代传4，高端诉讼传5，大成西安传6，大成金融传7，九赫法商传8，大成太原传9，大成郑州传10，大成沈阳传14，莱特法财税传15，河南律师之家传16，绿石诉讼资助传17，大成律师传18
    if(isFromWhichApp == 2){
    ...
    }else if(isFromWhichApp == 18){
      waterMarkFlag = 'dachenglvshi'
    }else{
