...
var ImgList = React.createClass({
  ...
  render: function() {
    var imgList = this.props.list.map(function(item,i){
      var imgStr = '?x-oss-process=image/resize,w_'+this.props.imgWidth+'/auto-orient,1/quality,q_90/format,jpg/watermark,image_ZmVlZGxvZ28yMDE3MDExOF9XNDJfSDM4X1M0LnBuZz94LW9zcy1wcm9jZXNzPWltYWdlL3Jlc2l6ZSxQXzEwCg==,type_ZmFuZ3poZW5nc2h1c29uZw==,size_15,text_'+this.props.basename+',color_FFFFFF,shadow_0,order_0,align_1,interval_10,t_60,g_se,x_10,y_10'
